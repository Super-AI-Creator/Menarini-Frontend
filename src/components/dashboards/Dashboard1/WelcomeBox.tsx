        ...
        <div className="grid grid-cols-12">
          <div className="md:col-span-7 col-span-12">
            <div className="flex gap-4 items-center">
              ...
              <h5 className="text-xl text-white">Welcome Back Admin</h5>
            </div>

            <div className="flex  w-full xl:mt-12 sm:mt-12 lg:mt-6 mt-6">
              <div className="border-e border-white/20 pe-4">
                <p className="text-white opacity-75 text-sm mb-1">Total Email</p>
                <h2 className="text-white text-2xl">3245</h2>
              </div>
              <div className="ps-4"> 
                <p className="text-white opacity-75 text-sm mb-1">Expect Email</p>
                <h2 className="text-white text-2xl">6574</h2>
              </div>
            </div>
          </div>
